...
This project analyses sales performance and customer behaviour for an online music store, with the goal of identifying revenue drivers, customer value and purchasing trends. 


### 📊Project Overview
This analysis explores sales performance and customer behaviour at the digital music store, *The Music Vault*. 
...
- **/dashboards**
     ...
     - **dashboard.pbix:** Interactive Power BI report file (Click download icon to open file in Power BI Desktop) [Download PBIX](dashboards/dashboard.pbix)
- **/data_clean:** Cleaned CSV files
- **/data_raw:** Raw CSV files before cleaning
- **/screenshots:** Project summarised in images
- **/scripts:** Python scripts used to clean the raw data
